...
const StoriesCard = ({ src, name, profile }) => {
    return (
        <div className='relative h-14 w-14 md:h-20 md:w-20 lg:h-72 lg:w-72 cursor-pointer overflow-x p-3 transition duration-100 transform ease-in hover:scale-100 hover:animate-pulse'>
