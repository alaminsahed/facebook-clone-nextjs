...
const Header = () => {
    ...
    //console.log(data)
    return (
        <div className='min-w-[600px] sm:min-w-[1000px] sticky top-0 items-center flex shadow-md p-2 lg:px-5 bg-white z-50'>
            ...
            <div className='flex items-center justify-end'>
                ...
                <Image onClick={() => signOut()} src={session.user.image} alt="avatar" height={40} width={40} className="inline-block rounded-full ring-2 ring-white cursor-pointer" />
